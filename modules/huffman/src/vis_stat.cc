...
template void visualize_histogram<uint8_t>(const std::string &, uint8_t *,
                                           size_t, size_t, bool, double, double,
                                           bool, bool);
template void visualize_histogram<uint16_t>(const std::string &, uint16_t *,
                                            size_t, size_t, bool, double,
                                            double, bool, bool);
template void visualize_histogram<uint32_t>(const std::string &, uint32_t *,
                                            size_t, size_t, bool, double,
                                            double, bool, bool);