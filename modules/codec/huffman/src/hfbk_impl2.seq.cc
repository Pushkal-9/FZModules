...
template void phf_CPU_build_codebook_v2(uint32_t*, size_t const, uint32_t*);
template void phf_CPU_build_codebook_v2(uint32_t*, size_t const, uint64_t*);
template void phf_CPU_build_codebook_v2(uint32_t*, size_t const, unsigned long long*);
