...
int fz::module::GPU_predict_spline(
...
template <typename T, typename E, typename FP>
int fz::module::GPU_reverse_predict_spline(
...
#define l3 xdata_len3
  ...
  fz::x_spline3d_infprecis_32x8x8data<E*, T*, float, DEFAULT_BLOCK_SIZE>  //
...
#define INSTANTIATE_FZCXX_MODULE_SPLINE__2params(T, E)                                     \
...
#define INSTANTIATE_FZCXX_MODULE_SPLINE__1param(T) \
  INSTANTIATE_FZCXX_MODULE_SPLINE__2params(T, u1); \
  INSTANTIATE_FZCXX_MODULE_SPLINE__2params(T, u2);

INSTANTIATE_FZCXX_MODULE_SPLINE__1param(f4);
INSTANTIATE_FZCXX_MODULE_SPLINE__1param(f8);

#undef SETUP
#undef INSTANTIATE_FZCXX_MODULE_SPLINE__1param
#undef INSTANTIATE_FZCXX_MODULE_SPLINE__2params
