...
class FzgCodec {
 ...
 public:
  ...
  FzgCodec* encode(E* in_data, size_t const data_len, uint8_t** out_comp,
                   size_t* comp_len, void* stream);

  FzgCodec* decode(uint8_t* in_comp, size_t const comp_len, E* out_data,
